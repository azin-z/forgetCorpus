...
class SilverExperminet(Experiment):
    def __init__(self, webiscorpus, name="silver", rm3=False, mini_index=False, rm3Terms=10, rm3Docs=10, rm3OrigWeight=0.5):
        ...
        super(SilverExperminet, self).__init__(name, webiscorpus, rm3=rm3, mini_index=mini_index, rm3Terms=rm3Terms, rm3Docs=rm3Docs, rm3OrigWeight=rm3OrigWeight)
